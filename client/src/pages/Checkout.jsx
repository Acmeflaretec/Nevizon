            ...
            <div className="row g-5">
              <div className="col-lg-8">
                {currentStep === 1 && (
                  <section className="card shadow-sm mb-4">
                    <div className="card-header bg-white border-bottom">
                      <h5 className="mb-0 text-danger">1. Shipping Address</h5>
                    </div>
                ...
                {currentStep === 2 && (
                  <section className="card shadow-sm mb-4">
                    <div className="card-header bg-white border-bottom">
                      <h5 className="mb-0 text-danger">2. Review Items</h5>
                    </div>
                    <div className="card-body">
                        ...
                        >
                          ...
                          <div className="col-md-6">
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              <span className="bg-danger-subtle text-danger px-2 py-1 rounded-pill">
                ...
                {currentStep === 3 && (
                  <section className="card shadow-sm mb-4">
                    <div className="card-header bg-white border-bottom">
                      <h5 className="mb-0 text-danger">3. Payment Options</h5>
                    </div>
                    <div className="card-body">
              ...
              <div className="col-lg-4">
                <div className="card shadow-sm">
                  <div className="card-header bg-white border-bottom">
                    <h5 className="mb-0 text-danger">Order Summary</h5>
                  </div>
                  <div className="card-body">
